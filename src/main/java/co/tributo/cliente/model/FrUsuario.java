...
public class FrUsuario implements Serializable {
    ...
    @JoinColumn(name = "fk_divipo", referencedColumnName = "id_ge_divipo")
    @ManyToOne
    private GeDivipo fkDivipo; 
	...
	public void setCompleteData(int completeData) {
    ...
    public GeDivipo getFkDivipo() {
        return fkDivipo;
    }

    public void setFkDivipo(GeDivipo fkDivipo) {
        this.fkDivipo = fkDivipo;
    }
    ...
    /**
     * @param expirtationCode the expirtationCode to set
     */
    public void setExpirationCode(Date expirtationCode) {
        this.expirationCode = expirtationCode;
    }

    /**
     * @return the verificaionCode
     */
    public String getVerificaionCode() {
        return verificaionCode;
    }

    /**
     * @param verificaionCode the verificaionCode to set
     */
    public void setVerificaionCode(String verificaionCode) {
        this.verificaionCode = verificaionCode;
    }
